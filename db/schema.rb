...
ActiveRecord::Schema.define(version: 20160218162501) do
  ...
  add_index "reviews", ["kitten_id"], name: "index_reviews_on_kitten_id", using: :btree
  ...
  add_foreign_key "reviews", "kittens"
end
